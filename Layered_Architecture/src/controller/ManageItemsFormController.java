...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
            ...
            for (ItemDTO itemDTO:
                    allItems) {
                tblItems.getItems().add(new ItemTM(itemDTO.getCode(),itemDTO.getDescription(), itemDTO.getUnitPrice(),
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
                ...
                //Save Item
                if (itemDAO.save(new ItemDTO(code, description, qtyOnHand, unitPrice))) {
            ...
            try {
                ...
                /*Update Item*/
                if (itemDAO.update(new ItemDTO(code, description, qtyOnHand, unitPrice))) {
                    tblItems.getItems().add(new ItemTM(code, description, unitPrice, qtyOnHand));
                }
    ...
    private String generateNewId() {
        try {
            return (String) itemDAO.newIdGenerate();
        } catch (SQLException e) {
            new Alert(Alert.AlertType.ERROR, e.getMessage()).show();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
